...
def gdf2NeoH5_task(gdf_file, t_start, t_stop, gdf_id_list):
    """
        ...
        Description: |
            ...
            Neo HDF5 file which can be processed by Elephant
