...
def tsodyks_depressing_task():
    ...
    filename = 'tsodyks_depressing.png'
    plt.savefig(filename)

    return tsodyks_depressing_task.task.uri.save_file(mime_type='image/png',
                                                      src_path=filename,
                                                      dst_path=filename)

if __name__ == '__main__':
    tsodyks_depressing_task()
