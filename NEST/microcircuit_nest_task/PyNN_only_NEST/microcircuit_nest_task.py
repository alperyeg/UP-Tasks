...
@task
def microcircuit_nest_task(K_scaling):
    '''
    ...
    doc['params_dict']['nest']['K_scaling'] = K_scaling

    with open('microcircuit.yaml', 'w') as f:
        yaml.dump(doc, f)
...
def _run_microcircuit(plot_filename):
    import sys
    # from sim_params import *
    # import yaml
...
if __name__ == '__main__':
    ...
    microcircuit_nest_task(K_scaling)
