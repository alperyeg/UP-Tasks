# @ job_name = "microcircuit_hpc_task"
# @ comment = "job microcircuit_hpc_task"
...
NESTCODE="/homea/jinb33/jinb3320/github_test/microcircuit_hpc_task/microcircuit_hpc_task.py"
